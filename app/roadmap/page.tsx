const quarters = [
  ...
  },
  {
    ...
    color: '#6366f1',
    items: [
      { status: 'planned', text: 'AI data entry — tell Crafty to bulk-import leads from a list' },
      { status: 'planned', text: 'Crafty AI customization — configure personality, packages, and pricing per business' },
      ...
      { status: 'planned', text: 'Booking contracts — digital contract attached to each booking' },
      { status: 'planned', text: 'Client portal — clients can view their booking and pay online' },
    ],
  },
  {
    ...
    color: '#a78bfa',
    items: [
      { status: 'planned', text: 'GCash payment link integration — auto-generate payment links in Messenger' },
      { status: 'planned', text: 'SMS follow-up via Semaphore or equivalent PH SMS gateway' },
      { status: 'planned', text: 'Multi-platform — Instagram DM and Viber inquiry support' },
      { status: 'planned', text: 'Team mode — add staff members with role-based access' },
      { status: 'planned', text: 'Revenue analytics — booking trends, peak months, top sources' },
    ],
  },
  {
    label: 'Future',
    ...
    items: [
      ...
      { status: 'idea', text: 'Marketplace — hire photographers, videographers, MUAs through the CRM' },
      { status: 'idea', text: 'Integrations — Canva, Google Drive, Facebook Ads Manager' },
      { status: 'idea', text: 'AI-generated follow-up scripts based on lead history' },
    ],
  },
]
