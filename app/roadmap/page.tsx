const quarters = [
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'planned', text: 'GCash payment link — auto-generate payment links in Messenger' },
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'idea', text: 'Multi-platform AI — Instagram DM and Viber inquiry support' },
      { status: 'idea', text: 'Client portal — clients view their booking and pay online' },
