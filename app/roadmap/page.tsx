const quarters = [
  ...
  },
  {
    ...
    items: [
      ...
      { status: 'planned', text: 'AI next-action badges — rule-based label on each lead: "Event in 2 weeks, unbooked — follow up now"' },
      { status: 'planned', text: 'Payments redesign — booking status cards (Unpaid, Deposit Paid, Fully Paid, Overdue)' },
      { status: 'planned', text: 'Custom package builder — click to select base package + add-ons, total auto-calculates, flows into invoice' },
